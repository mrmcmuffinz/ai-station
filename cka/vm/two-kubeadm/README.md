...
### [03 - Node Prerequisites](docs/03-node-prerequisites.md)
...
### [04 - Control Plane Init](docs/04-control-plane-init.md)
...
### [05 - CNI Installation](docs/05-cni-installation.md)
...
### [06 - Worker Join](docs/06-worker-join.md)
