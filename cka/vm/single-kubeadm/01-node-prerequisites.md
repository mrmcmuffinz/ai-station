...
**Based on:** [04-container-runtime.md](../../single-systemd/docs/04-container-runtime.md) of the systemd guide and the upstream [kubeadm install documentation](https://kubernetes.io/docs/setup/production-environment/tools/kubeadm/install-kubeadm/).
...
The VM must be created and reachable. If you have not already created it, run `cka/vm/single-systemd/docs/01-qemu-vm-setup.md` first. SSH into the VM:
