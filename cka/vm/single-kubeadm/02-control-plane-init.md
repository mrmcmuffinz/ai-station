...
**Based on:** [03-control-plane.md](../../single-systemd/docs/03-control-plane.md) of the systemd guide (replaced wholesale by `kubeadm`) and the upstream [kubeadm init documentation](https://kubernetes.io/docs/setup/production-environment/tools/kubeadm/create-cluster-kubeadm/).
