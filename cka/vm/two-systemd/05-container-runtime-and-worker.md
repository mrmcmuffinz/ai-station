...
**Based on:** [04-container-runtime.md](../../single-systemd/docs/04-container-runtime.md) and [05-worker-components.md](../../single-systemd/docs/05-worker-components.md) of the single-node guide.
